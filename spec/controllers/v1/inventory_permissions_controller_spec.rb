...
describe V1::InventoryPermissionsController do
  ...
  describe '#show' do
    ...
    context 'logged-in user' do
      ...
      let(:inventory) { create(:inventory, :with_participants, :with_facilitators, facilitators: 2, participants: 2) }
  ...
  describe '#update' do
    ...
    context 'logged-in user' do
      let(:user) { create(:user) }
      let(:inventory) { create(:inventory, :with_participants, participants: 2) }
