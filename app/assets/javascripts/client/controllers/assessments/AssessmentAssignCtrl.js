PDRClient.controller('AssessmentAssignCtrl', [
  ...
  'Participant',
  'Rubric',
  AssessmentAssignmentCtrlFunction]);

function AssessmentAssignmentCtrlFunction($scope, $timeout, $anchorScroll, $location, $stateParams, SessionService, Assessment, Participant, Rubric) {
  ...
  $scope.$watch('$scope.assessment.due_date', function (value) {
