PDRClient.directive('inventoryParticipants', ['SessionService', 'Assessment', '$timeout', '$modal',
    function(SessionService, Assessment, $timeout, $modal) {
      return {
        restrict: 'E',
        replace: false,
        templateUrl: 'client/views/directives/inventories/manage_participants.html',
        scope: {
          'inventoryId': '@',
          'sendInvite': '@',
          'numberOfRequests': '@',
        ...
        controller: ['$scope', '$timeout', '$modal', 'Participant', 'AssessmentPermission', function($scope, $timeout, $modal, Participant, AssessmentPermission) {
          ...
          $scope.showAddParticipants = function() {
            ...
            $scope.modalInstance = $modal.open({
              ...
              templateUrl: 'client/views/modals/inventories/manage_participants.html',
              scope: $scope,
              size: 'lg'
            });
          };
