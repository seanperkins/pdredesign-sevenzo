module InviteToolMessageHelper
  ...
  def default_analysis_message
    ...
    To participate along with your colleagues, you must first register with the PDredesign. Once registered, you'll have ongoing access to the analysis and results. Please contact #{current_user.name} with any questions at #{current_user.email}."
  end
end
